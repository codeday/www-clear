...
export function CreatePersonModal({ children, ...props }: any) {
...
export function UpdatePersonModal({ person, children, ...props }: any) {
  const [open, setOpen] = useState(false);
...
export function DeletePersonModal({ person, children, ...props }: any) {
  const [open, setOpen] = useState(false);
  const { data: session } = useSession();
