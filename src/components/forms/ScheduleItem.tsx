...
// export function CreateScheduleItemModal({ event, group, children, ...props }: any) {
...
// export function UpdateScheduleItemModal({ scheduleitem, children, ...props }: any) {
//   const [open, setOpen] = useState(false);
...
// export function DeleteScheduleItemModal({ scheduleitem, children, ...props }: any) {
//   const [open, setOpen] = useState(false);
//   const { data: session } = useSession();
...
export const UpdateScheduleItem = CreateScheduleItem;
export const DeleteScheduleItem = CreateScheduleItem;
