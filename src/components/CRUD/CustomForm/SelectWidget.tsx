...
import { FormControl, FormLabel } from '@codeday/topo/Atom';
import {
  ariaDescribedByIds,
  EnumOptionsType,
...
export default function SelectWidget<T = any, S extends StrictRJSFSchema = RJSFSchema, F extends FormContextType = any>(
  ...
  return (
    ...
    >
      {labelValue(
        <FormLabel fontWeight="normal" htmlFor={id} id={`${id}-label`}>
          {label}
        </FormLabel>,
        hideLabel || !label,
      )}
      <Select
        ...
        chakraStyles={{
          menuList: (provided) => ({
            ...provided,
            bg: useColorModeValue('white', 'var(--chakra-colors-gray-1100)'),
          }),
          control: (provided) => ({
            ...provided,
