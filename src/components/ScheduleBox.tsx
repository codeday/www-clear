...
export default function ({
    ...
    const finalizedExternalEvents = schedule.filter((val: any) => val.finalized && !val.internal);
    const nonfinalizedExternalEvents = schedule.filter((val: any) => !val.finalized && !val.internal);
    const internalEvents = schedule.filter((val: any) => val.internal);
    return (
