  ...
  return (
    <Box>
      {drawDays.map((date) => (
        <>
          <Divider />
          <Text fontSize="sm" color="gray.500" ml={5} mb={2} textAlign="left">
            ...
            {date.format('YYYY-MM-DD') in eventsByDay
              ? eventsByDay[date.format('YYYY-MM-DD')]
                ...
                .map((e) => {
                  ...
                  return (
                    <Link href={`schedule/${e.id}`} passHref>
                      <Box
                        as="a"
                        display="block"
                        m={1}
                      ...
                      >
                        ...
                        <Text display="inline" m={2} color="black">
                          {e.displayTime}
                        </Text>
                        <Box m={4}>
                          <Box color="black">
