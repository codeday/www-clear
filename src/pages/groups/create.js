...
import {GroupAddMutation} from './groups.graphql'
...
export default function CreateGroup(){
    ...
    const [group, setGroup] = useReducer(
        (prev, next) => Array.isArray(next) ? {...prev, [next[0]]: next[1] } : next, {'ticketPrice': 20.00, 'earlyBirdPrice': 15.00}
    );
    return (
        <Page title="Create Event Group" slug="/admin/groups/create">
            <Content>
                {/*// name*/}
                {/*// startDate*/}
                {/*// endDate*/}
